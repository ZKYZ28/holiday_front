  ...
  String get message {
    switch (this) {
      case DescriptionHolidayInputError.invalid:
        return "Champ faculatif. Autrement, la description doit contenir entre 0 et 500 caractères et peut inclure des lettres, des chiffres, des apostrophes, des tirets, des espaces et certains caractères spéciaux.";
      default:
