  ...
  String get message {
    switch (this) {
      case StreetInputError.invalid:
        return 'Champ faculatif. Si vous choisissez de le remplir, veuillez saisir une adresse de rue valide contenant entre 1 et 100 caractères. Seules les lettres, chiffres, espaces, apostrophes, points, virgules et tirets sont autorisés.';
      default:
