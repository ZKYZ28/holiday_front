          ...
          child: BlocListener<ActivityBloc, ActivityState>(
            ...
            child: BlocBuilder<ActivityBloc, ActivityState>(
              builder: (context, state) {
                if (state.status == ActivityStateStatus.initial ||
                    state.status == ActivityStateStatus.loading) {
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        ...
                        List<geocoding.Location> geocodedLocations =
                            await Location.locationsFromAddress(
                                activity.location.getFormattedAddress());
                        context.router.push(MapRoute(
                            destinationLatitude: geocodedLocations[0].latitude,
                            destinationLongitude:
                                geocodedLocations[0].longitude,
